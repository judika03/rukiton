...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Rumah Sakit Kita<br>Administrator</h1>
...
$cek = mysqli_query($con, "select * from admin where username = '$username' and password = '$password'");
